...
namespace TemplateDomain.WebApi
{
    public class Startup : ModularStartup
    {
        ...
        {
            var store = new RavenDocumentStoreFactory().CreateDocumentStore(RavenConfig.FromConfiguration(Configuration));  // leave it here to avoid lazy loading until this is refactored so that this comment is NOT NEEDED
